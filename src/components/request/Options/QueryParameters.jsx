...
const QueryParameters = ({ setQueryParams, queryParams }) => {
  ...
  return (
    <div className="flex justify-center flex-col over h-full my-4">
      <div className="font-montserrat text-sm flex h-10 justify-center items-start w-full gap-2 my-2 ">
        <input
          type="text"
          placeholder="Key"
          value={key}
          className="h-10  w-[30%] font-montserrat py-2 px-2 outline-none border-2 border-gray-300  focus:border-blue-500"
        ...
        />
        <Button
          className="h-10 text-white font-montserrat bg-httpx hover:bg-blue-800  px-5 py-2   w-32 flex justify-center items-center"
          onClick={handleClick}
        >
          Add
        </Button>
      ...
      {queryParams.map((queryParameter) => (
        ...
        >
          <div className="h-8 w-[30%] font-montserrat py-2 px-2 outline-none border-2 border-gray-300  focus:border-blue-500 flex justify-start items-center">
            {queryParameter.key}
          </div>
          <div className="h-8 w-[30%] font-montserrat py-2 px-2 outline-none border-2 border-gray-300  focus:border-blue-500 flex justify-start items-center">
